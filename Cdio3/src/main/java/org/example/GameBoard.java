...
import java.awt.Color;
 ...
 public class  GameBoard {
     ...
     public static GUI_Field[] makeFields() {
         ...
         board[i++] = new GUI_Tax( "Skattevæsnet", "eller 10%", "Pris 4000kr", new Color(255,255,255), Color.BLACK);
         board[i++] = new GUI_Shipping("Ferry1","Helsingørbåden","Pris 4000kr", "Lineart pr båd" , "500", new Color(105, 156, 250), Color.BLACK);
         ...
         board[i++] = new GUI_Refuge(" default", "på besøg", "Sig hej til de fængslende", "", new Color(255, 255, 255), Color.WHITE);
         board[i++] = new GUI_Street("Frederiksberg Allé", "Pris:  ", "Startleje 200", "200", new Color(222,220,73), Color.BLACK);
         board[i++] = new GUI_Brewery("Tuborg Squash", "Pris : 3000kr","Sodavandskæde, flere kan ejes", "Double pris hvis 2 ejet", "100kr", Color.YELLOW, Color.ORANGE);
         ...
         board[i++] = new GUI_Shipping("Ferry2","Molslinjen","Pris 4000kr", "Lineart pr båd" , "500", new Color(255, 50, 5), Color.BLACK);
         ...
         board[i++] = new GUI_Refuge(" default", "Parkering", "Tag en pause ", "intet sker", new Color(255, 255, 255), Color.WHITE);
         ...
         board[i++] = new GUI_Shipping("Ferry3","Gedser-båden","Pris 4000kr", "Lineart pr båd" , "500", new Color(105, 156, 250), Color.BLACK);
         ...
         board[i++] = new GUI_Brewery("Coca Cola", "Pris : 3000kr","Sodavandskæde, flere kan ejes", "Double pris hvis 2 ejet", "100kr", Color.RED, Color.ORANGE);
         ...
         board[i++] = new GUI_Shipping("Ferry4","Helsingørbåden","Pris 4000kr", "Lineart pr båd" , "500", new Color(105, 156, 250), Color.BLACK);
         board[i++] = new GUI_Chance("?", "Prøv lykken", "Ta' et chancekort.", new Color(204, 204, 204), Color.BLACK);
         board[i++] = new GUI_Tax( "Statskassen", "", "Pris 2000kr", new Color(255,255,255), Color.BLACK);
