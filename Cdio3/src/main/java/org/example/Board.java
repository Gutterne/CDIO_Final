...
public class Board {
 ...
 public Board(){
  ...
  fieldlist[5]= new Ferry("Helsingør - Helsingborg","Lyseblå",7,4000,500,1000,2000,4000);
  fieldlist[6]= new BuyableField("Roskildevej","Orange",8,2000,
          100,600,1800,5400,8000,11000);
  fieldlist[7]= new Chance("Prøv Lykken",9);
  fieldlist[8]= new BuyableField("Valby Langgade","Orange",10,2000,
          100,600,1800,5400,8000,11000);
  fieldlist[9]= new BuyableField("Allégade","Orange",11,2400,
          150,800,2000,6000,9000,12000);
  fieldlist[10]= new Prison("I fængsel (På Besøg)",12);
  fieldlist[11]= new BuyableField("Frederiksberg allé","Grøn",13,2800,
          200,1000,3000,9000,12500,15000);
  fieldlist[12]= new Brewery("Tuborg Squash","Rød",14,3000,100,200);
  fieldlist[13]= new BuyableField("Bülowsvej","Grøn",15,2800,
          200,1000,3000,9000,12500,15000);
  fieldlist[14]= new BuyableField("Gammel kongevej","Grøn",16,3200,
          250,1250,3750,10000,14000,18000);
  fieldlist[15]= new Ferry("Mols-linjen","Mørkeblå",18,4000,500,1000,2000,4000);
  fieldlist[16]= new BuyableField("Bernstorffsvej","Grå",19,3600,
          300,1400,4000,11000,15000,19000);
  fieldlist[17]= new Chance("Chance",20);
  fieldlist[18]= new BuyableField("Hellerupvej","Grå",21,3600,
          300,1400,4000,11000,15000,19000);
  fieldlist[19]= new BuyableField("Strandvejen","Grøn",22,4000,
          350,1600,4400,12000,16000,20000);
  fieldlist[20]= new Parking("Parkering","Intet",23,0);
  fieldlist[21]= new BuyableField("Trianglen","Rød",24,4400,
          350,1800,5000,14000,17500,21000);
  fieldlist[22]= new Chance("Prøv Lykken",25);
  fieldlist[23]= new BuyableField("Østerbrogade","Rød",26,4400,
          350,1800,5000,14000,17500,21000);
  fieldlist[24]= new BuyableField("Grønningen","Rød",27,4800,
          400,2000,6000,15000,18500,22000);
  fieldlist[25]= new Ferry("Gedser - Rostock","Mørkeblå",29,
          4000,500,1000,2000,4000);
  fieldlist[26]= new BuyableField("Bredgade","Hvid",30,5200,
          450,2200,6600,16000,19500,23000);
  fieldlist[27]= new BuyableField("Kongens Nytorv","Hvid",31,5200,
          450,2200,6600,16000,19500,23000);
  fieldlist[28]= new Brewery("Coca Cola","Rød",32,3000,100,200);
  fieldlist[29]= new BuyableField("Østergade","Hvid",33,5600,
          500,2400,7200,17000,20500,24000);
  fieldlist[30]= new Hardprison("FÆNGSEL!",34);
  fieldlist[31]= new BuyableField("Amagertorv","Gul",35,6000,
          550,2600,7800,18000,22000,25000);
  fieldlist[32]= new BuyableField("Vimmelskaftet","Gul",36,6000,
          550,2600,7800,18000,22000,25000);
  fieldlist[33]= new Chance("Prøv Lykken",37);
  fieldlist[34]= new BuyableField("Nygade","Gul",38,6400,
          600,3000,9000,20000,24000,28000);
  fieldlist[35]= new Ferry("Rødby-Puttgarden","Mørkeblå",40,
          4000,500,1000,2000,4000);
  fieldlist[36]= new Chance("Prøv Lykken",41);
  fieldlist[37]= new BuyableField("Frederiksberggade","Purple",42,7000,
          700,3500,10000,22000,26000,30000);
  fieldlist[38]= new Tax("Tax",43,2000);
  fieldlist[39]= new BuyableField("Rådhuspladsen","Lilla",44,8000,
